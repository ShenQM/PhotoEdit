...
class WorkWidget(QtWidgets.QWidget):
    ...
    def load_folder(self, folder=''):
        if os.path.exists(folder):
            ...
            r = 0
            c = 0
            flowchart = FlowChart.FlowLayout()
            for i in range(len(self.file_list.rgb_obj)):
                ...
                flowchart.addWidget(self.label[i])
            print('{}_{}'.format(r, c))
            ...
            self.scroll.setLayout(flowchart)
            self.scroll.resize(600, 600)
            #self.setwid(self.scroll)
            print('{}_{}'.format(self.column_num, self.width()))
